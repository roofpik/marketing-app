app.controller("travelOutstationCtrl", function($scope, $state, $timeout, $filter, $cordovaGeolocation, $ionicPopup,$ionicLoading) {
            ...
            .then(function(position) {
                ...
                if ($scope.toggle == "Start Activity") {
                   ...
                   template: 'Fill the summary now :)'
                    ...
                    updates['/activity/' + userid + '/' + dates + '/' + $scope.activityId + '/summary/start_city'] = foo.start_city_name;
                    updates['/activity/' + userid + '/' + dates + '/' + $scope.activityId + '/summary/end_city'] = foo.end_city_name;
                    firebase.database().ref().update(updates);
                    $scope.toggle = "Completed";
