app.controller("emailCtrl", function($scope, $state, $timeout,$filter, $cordovaGeolocation, $ionicPopup,$ionicLoading) {
    ...
    function getActivitydetails() {
        firebase.database().ref('/activity/' + userid + '/'+dates+'/' + $scope.activityId).on('value', function(snapshot) {
            ...
            console.log($scope.actDetails);
             ...
             $scope.todetails=$scope.actDetails.planning.toEmail;
             $scope.ccdetails=$scope.actDetails.planning.ccEmail;
             $scope.attachments=$scope.actDetails.planning.attachments.link;
             console.log($scope.todetails);
